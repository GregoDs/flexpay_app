...
class CreateVoucherResponse {
  ...
  /// Collects all nested error messages, including from [data]
  ...
  /// Recursively flattens various error formats
...
class VoucherData {
  ...
  factory VoucherData.fromJson(Map<String, dynamic> json) {
    ...
    VoucherDetails? parsedData;

    if (innerData is Map<String, dynamic>) {
      parsedData = VoucherDetails.fromJson(innerData);
    }
  ...
  /// Extract readable error messages from the nested `errors`
