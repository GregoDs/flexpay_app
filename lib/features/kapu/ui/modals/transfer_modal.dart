...
Future<bool?> showKapuTransferModalSheet(
  ...
  // ✅ Exclude the currently open Kapu (cannot transfer to same merchant)
  final List<Map<String, dynamic>> recipientMerchants = merchants
      .where((m) => m['merchant_id'].toString() != fromMerchantId)
      .toList();
                          ...
                          Container(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButton<String>(
                                ...
                                items: recipientMerchants.map((merchant) {
                                ...
                                onChanged: (value) {
                                  setState(() {
                                    ...
                                    selectedMerchantId = recipientMerchants
                                        .firstWhere(
                                          (m) => m['name'] == value,
                                        )['merchant_id'];
                                  });
