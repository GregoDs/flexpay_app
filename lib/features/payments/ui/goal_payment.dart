                ...
                listener: (context, state) async {
                  ...
                  if (state is GoalWalletPaymentSuccess) {
                    CustomSnackBar.showSuccess(
                      ...
                      message: "Goal payment completed successfully ✅",
                    );

                    setState(() => localLoading = true);

                    // Keep the spinner visible while refreshing
                    CustomSnackBar.showInfo(
                      context,
                      title: "Processing Payment...",
                      message: "Please wait while we update your goal...",
                    );
                  ...
                  // Errors
                    ...
                    CustomSnackBar.showError(
                      ...
                      message: state is GoalWalletPaymentError
                          ? state.message
                          : (state as GoalMpesaPaymentError).message,
                    );
                  }
                },
                child: Padding(
