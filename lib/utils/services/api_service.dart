...
class ApiService {
  ...
  static String prodEndpointBookingsKapu = dotenv.env['PROD_ENDPOINT_BOOKINGS_KAPU']!;
    static String prodEndpointKapuWalletShops = dotenv.env['PROD_ENDPOINT_KAPU_WALLET_SHOPS']!;
